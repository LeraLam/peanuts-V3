package com.leralam.peanuts.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.leralam.peanuts.service.EmailAlreadyUsedException ||
            ex instanceof com.leralam.peanuts.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.leralam.peanuts.service.InvalidPasswordException
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "com.leralam.peanuts");
    }
}
